...
这是正在完善中的 MVP。当前已经包含：带密码保护的房东和租客门户、房屋/租客/租约/租金账单/维修/文件/租约模板核心 CRUD 页面、地图视图和 lease PDF 生成管线。后续生产化工作还包括更完整的编辑表单、文件上传存储、租金自动生成、租客提交维修表单，以及经律师审阅后的完整 lease 渲染。
